...
class FuturePracticeViewPage extends StatefulWidget {
  const FuturePracticeViewPage({super.key, required this.programId});

  final String programId;

  @override
  State<FuturePracticeViewPage> createState() => _FuturePracticeViewPageState();
}

class _FuturePracticeViewPageState extends State<FuturePracticeViewPage> {
  ...
  Future<void> _init() async {
    ...
    final response = await getMethods.getExercices(widget.programId);
    setState(() {
      exercises = response;
    });
  }
        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton.icon(
              onPressed: () => context.push('/schedule/edit', extra: int.parse(widget.programId)),
